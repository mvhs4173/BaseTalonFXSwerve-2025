...
public final class Constants {
    ...
    public static final class Swerve {
        ...
        public static final double angleClosedLoopRamp = 0.5;
        ...
        /** Meters per Second */
        public static final double maxSpeed = (2.5 / 4); //This must be tuned to specific robot, normally 3.5 but 2.5 for this branch
        /** Radians per Second */
        public static final double maxAngularVelocity = (0.5 / 4); //This must be tuned to specific robot
