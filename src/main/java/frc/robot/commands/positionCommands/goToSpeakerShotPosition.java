...
public class goToSpeakerShotPosition extends ParallelCommandGroup {
  Shoulder m_shoulder;
  Wrist2 m_wrist2;
  double timeout;
  /** Creates a new AutoGoToAmpShotPosition. */
  public goToSpeakerShotPosition(Shoulder shoulder, Wrist2 wrist2) {
m_shoulder = shoulder;
m_wrist2 = wrist2;
timeout = 7.0;
    ...
    addCommands(
      ...
      new Wrist2GoToPosition(m_wrist2, 0.35, 0.215).withTimeout(timeout)
    );
  }
}
