...
public class rightSpeaker extends SequentialCommandGroup {
    Swerve s_Swerve;
    Shoulder m_shoulder;
    Wrist2 m_wrist2;
    Shooter2 m_shooter2;
    public rightSpeaker(Swerve swerve, Shoulder shoulder, Wrist2 wrist2, Shooter2 shooter2){
        s_Swerve = swerve;
        m_shoulder = shoulder;
        m_wrist2 = wrist2;
        m_shooter2 = shooter2;
        ...
        addCommands(
            ...
            new InstantCommand(() -> s_Swerve.setPose(new Pose2d(Units.feetToMeters(0), Units.feetToMeters(0), new Rotation2d(Units.degreesToRadians(180 + 60))))),
